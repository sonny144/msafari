...
})({"8a8AF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "48957533c0002682";
"use strict";
...
},{}],"2Ssp9":[function(require,module,exports,__globalThis) {
...
async function loadTranslations() {
    ...
    try {
        ...
        if (!enResponse.ok || !frResponse.ok) throw new Error(`Failed to load translation files: en: ${enResponse.status} ${enResponse.statusText}, fr: ${frResponse.status} ${frResponse.statusText}`);
        ...
        (0, _i18NextDefault.default).init({
            lng: 'en',
            resources: {
                en: {
...
document.getElementById('language-select').addEventListener('change', async (event)=>{
    await (0, _i18NextDefault.default).changeLanguage(event.target.value);
    updateContent();
});
function updateContent() {
    document.querySelectorAll('[id]').forEach((element)=>{
        if ((0, _i18NextDefault.default).exists(element.id)) element.tagName === 'TITLE' ? document.title = (0, _i18NextDefault.default).t(element.id) : element.innerHTML = (0, _i18NextDefault.default).t(element.id);
    });
}
...
},{"i18next":"dBBdt","@parcel/transformer-js/src/esmodule-helpers.js":"6SKcv"}],"dBBdt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"6SKcv"}],"6SKcv":[function(require,module,exports,__globalThis) {
...
},{}]},["8a8AF","2Ssp9"], "2Ssp9", "parcelRequireef08", {})

//# sourceMappingURL=msafari.c0002682.js.map
